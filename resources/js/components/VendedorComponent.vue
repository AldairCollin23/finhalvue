...
<div>
  <div class="row">
    ...
    <input v-model="dni" type="text" placeholder="DNI" class="form-control">
     ...
     <div class="col">
    <label>Nombre</label>
    <input v-model="nombrevendedor" type="text" placeholder="Nombre" class="form-control">
    </div>
    <div class="col">
    <label>Apellido</label>
    <input v-model="apellidovendedor" type="text" placeholder="Apellido" class="form-control">
    </div>
    <div class="col">
    <label>Celular</label>
...
<div class="col-md-12">
    <br>
        <div class="container-buttons">
                    ...
                    <a link rel="stylesheet" href="http://127.0.0.1:8000/vendedor-vue/descarga" class="btn btn-outline-dark">PDF</a>
                ...
                <table class="table text-center"><!--Creamos una tabla que mostrará todas las tareas-->
                        ...
                        <tbody>
                            <tr v-for="task in arrayTasks" :key="task.id"> <!--Recorremos el array y cargamos nuestra tabla-->
                                ...
                                <td v-text="task.apellidovendedor"></td>
...
<script>
  ...
  buscar(){
          ...
          this.celular=res.data.data.celular_completa;
         ...
         // this.txtemail="Ira el email";
            ...
            saveTasks(){
                ...
                axios.post(url,{ //estas variables son las que enviaremos para que crear la tarea
                    ...
                    'apellidovendedor':this.apellidovendedor,
            ...
            loadFieldsUpdate(data){ //Esta función rellena los campos y la variable update, con la tarea que queremos modificar
                ...
                axios.get(url).then(function (response) {
                    ...
                    me.apellidovendedor= response.data.apellidovendedor;
