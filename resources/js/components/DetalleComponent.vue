<template>
  <div class="container container-task">
    <div class="row">
      <div class="col-md-7">
        <h2 class="text-primary">Detalle Venta</h2>
...
export default {
  ...
  methods: {
    getTasks() {
      let me = this;
      let url = "/detalles"; //Ruta que hemos creado para que nos devuelva todas las idcita
      axios
        .get(url)
    ...
    saveTasks() {
      let me = this;
      let url = "/detalles/guardar"; //Ruta que hemos creado para enviar una tarea y guardarla
      axios
        .post(url, {
    ...
    loadFieldsUpdate(data) {
      ...
      let me = this;
      let url = "/detalles/buscar?iddetalle=" + this.update;
      axios
        .get(url)
        .then(function (response) {
    ...
    deleteTask(data) {
      ...
      if (confirm("¿Seguro que deseas borrar esta tarea?")) {
        axios
          .delete("/detalles/borrar/" + task_id)
          .then(function (response) {
            me.getTasks();
          })
          .catch(function (error) {
